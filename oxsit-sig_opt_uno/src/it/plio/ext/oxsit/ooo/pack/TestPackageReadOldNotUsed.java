...
import com.sun.star.embed.XExtendedStorageStream;
import com.sun.star.embed.XHierarchicalStorageAccess;
...
//call the recursive method to print the folder content
            ...
            Logger.getLogger(TestPackageReadOldNotUsed.class.getName()).log(Level.SEVERE, null, ex);
        }        
    }
...
/*                Utilities.showInfo(xPackStreamContent);
                Utilities.showInterfaces(xPackStreamContent);*/
...
//            ex.printStackTrace(System.out);
     ...
     * @param aTheDocURL
     */
    public void examinePackageODT(String aTheDocURL, XMultiComponentFactory _xMCF, XComponentContext _xCompCtx) {
        try {
...
//            XInterface oPkg = (XInterface) xMSF.createInstance("com.sun.star.packages.Package");
            XInterface oPkg = (XInterface) _xMCF.createInstanceWithContext("com.sun.star.packages.Package", _xCompCtx);

// lists the available services
/*            Utilities.showInfo(oPkg);
            Utilities.showInterfaces(oPkg);*/
            ...
            if( !xHierachAcc.hasByHierarchicalName("META-INF") )
                System.out.println(" no manifest directory");
            else
                System.out.println(" manifest directory exists");
            
//grab the manifest file, but first the folder
            Object aObj = xHierachAcc.getByHierarchicalName("META-INF");
            if (aObj != null) {
...
//            Utilities.showInfo(xHierachAcc);
//            Utilities.showInterfaces(this, xHierachAcc);
...
// get the manifest
/*            Object oManfst = _xMCF.createInstanceWithContext("com.sun.star.packages.manifest", _xCompCtx);
    ...
    /**
     * 
     * @param _aURL the document url. The package will be 'read' from this
     */
    public void checkSignatureStatus(String _aURL) {
    	
    }
    
    private void runTestDoNotUse() {
/*        try*/ {
/*            if(SvrInfo.InitConnection())*/ {
                System.out.println("Connection successful !");           
            //try to get a document
                Object desktop = null;/*SvrInfo.getFactory().createInstanceWithContext("com.sun.star.frame.Desktop",
                        SvrInfo.getCompCtx());*/
...
//get this document model
                    ...
                    xMCF = null;//SvrInfo.getFactory();
                    xCC = null; //SvrInfo.getCompCtx();
...
/*        catch(Exception e) {
    ...
    public static void mainMy(String[] args) {
        // TODO code application logic here
            theInstance = new TestPackageReadOldNotUsed();
            theInstance.runTestDoNotUse();
...
//			System.out.println(aElements[i]);
    ...
    private Vector<String> createElemeList(Object _othePackage) {
		...
		if(xPropset != null) { // grab the version
			...
			if(sVersion.length() != 0)
				System.out.println("Version is: "+sVersion); // this should be 1.2 or more
			else
				System.out.println("Version is 1.0 or 1.1");
		}
     ...
     * @param _xCompCtx
     */
    public void readManifestFromStorage(String aTheDocURL, XMultiComponentFactory _xMCF, XComponentContext _xCompCtx) {
    	try {	
			...
			if(oObj != null) {
	            ...
	            for(int i = 0; i < aElements.size();i++) {
					System.out.println(aElements.get(i));	            	
	            }
			}
			else
