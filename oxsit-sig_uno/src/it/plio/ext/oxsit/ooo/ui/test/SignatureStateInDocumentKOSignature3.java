...
public class SignatureStateInDocumentKOSignature3 extends SignatureStateInDocument {

	public SignatureStateInDocumentKOSignature3( XComponentContext _Context, XMultiComponentFactory _xMCF) {
		super("Lorenzo Rossi", _Context, _xMCF);
		String sUserN = "Lorenzo";
		String sUserC = "Rossi";
