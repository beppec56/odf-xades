...
install_a_lang() {
    ...
    export SRCDEBS=$OOBUILDDIR"/instsetoo_native/"$INPATH"/OpenOffice_languagepack/deb/install/$LANG/DEBS"

    popd
    echo "$ROOTDIR $TARGETINST"
